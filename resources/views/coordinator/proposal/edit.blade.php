...
@section('content')
    ...
    <form class="form-horizontal" action="{{ route('coordinator.proposal.update', ['id' => $proposal->id]) }}" method="post">
        @csrf
        @method('PUT')
                        ...
                        <div class="form-group @if($errors->has('email')) has-error @endif">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="inputEmail" name="email"
                                       placeholder="andcastro28@gmail.com" value="{{ old('email') ?? $proposal->email }}"/>
                        ...
                        <div class="form-group @if($errors->has('subject')) has-error @endif">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputSubject" name="subject"
                                       placeholder="Estágio/CTI" value="{{ old('subject') ?? $proposal->subject }}"/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('other')) has-error @endif">
                            ...
                            <textarea class="form-control" rows="2" id="inputOther" name="other"
                                      style="resize: none">{{ old('other') ?? $proposal->other }}</textarea>
